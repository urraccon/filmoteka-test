 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,e=!0){Wi="10.7.1",gt(new O("firestore",((t,{instanceIdentifier:n,options:r})=>{const i=t.getProvider("app").getImmediate(),s=new fl(new ls(t.getProvider("auth-internal")),new ps(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new os(ss.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ho(t.options.projectId,e)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s}),"PUBLIC").setMultipleInstances(!0)),Et("@firebase/firestore","4.4.0",t),Et("@firebase/firestore","4.4.0","esm2017")}();const Ll=ll(function(t,e){const n="string"==typeof t?t:e||"(default)",r=pt("object"==typeof t?t:wt(),"firestore").getImmediate({identifier:n});if(!r._initialized){const t=_("firestore");t&&al(r,...t)}return r}(vt({apiKey:"AIzaSyAKYrF2YoqGKSaSU407C9X91DqaZMAg4q4",authDomain:"filmoteka-urraccon.firebaseapp.com",projectId:"filmoteka-urraccon",storageBucket:"filmoteka-urraccon.appspot.com",messagingSenderId:"712511464775",appId:"1:712511464775:web:f28be5eb7fc38469c69862"})),"watched_and_queued_movie_list","your-device-ID");!async function(){const t=await Nl(Ll);t.exists()?console.log("Document data:",t.data()):console.log("No such document!")}();
//# sourceMappingURL=index.2f586f36.js.map
